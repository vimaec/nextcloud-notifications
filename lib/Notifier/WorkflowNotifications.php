...
class WorkflowNotifications implements INotifier {
	...
	public function getName(): string {
		return $this->l10nFactory->get('notifications')->t('Workflow notifications');
	}
	...
	public function prepare(INotification $notification, string $languageCode): INotification {
		...
		$l = $this->l10nFactory->get('notifications', $languageCode);
		switch ($notification->getSubject()) {
			case '\\OCP\\Files::postWrite':
				$subjectParams = $notification->getSubjectParameters();
				$notification->setParsedSubject($l->t('%1$s has updated %2$s', [$subjectParams['user'], $subjectParams['fileName']]));
